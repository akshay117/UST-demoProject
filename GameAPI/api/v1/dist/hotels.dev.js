...
var VERSION = 'v1';
var URI = '/' + VERSION + '/' + RESOURCE_NAME; // Setup the vacations db
...
module.exports = function (router) {
  ...
  router.route(URI).get(function (req, res, next) {
    ...
    console.log(options); //3. execute the query
    ...
    db.select(criteria, options, function (err, docs) {
      if (err) {
        ...
        console.log("Retrieved hotels = %d", docs.length); // 4. Set the Link header - Left as an exercise for the students
